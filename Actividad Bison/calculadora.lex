...
{DIGITO}* {yylval = atoi(yytext); return NUM; /* Convierte el NUM a nÃºmero */}
...
"%"       {return MODU;/* Se encontró un símbolo de división */}
"^"       {return EXPO;/* Se encontró un símbolo de división */}
